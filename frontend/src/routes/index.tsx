  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      ...
      <div className="flex flex-row justify-between">
        <h1 className="text-xl">Martin Shaw's Cloud Duplicate File Finder</h1>
        {isOnline ? (
          <div className="flex flex-row gap-3 items-center animate-pulse">
            <div className="w-4 h-4 aspect-square rounded-full bg-green-500"></div>
            Online
          </div>
        ) : (
          <div className="flex flex-row gap-3 items-center animate-pulse">
            <div className="w-4 h-4 aspect-square rounded-full bg-red-500"></div>
            Offline
          </div>
        )}
      </div>
